...
class ChatReadRetrieveReadVisionApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """
        You are an intelligent assistant helping the employees to learn more about the systems in the company with the documents about those systems. The documents contain text, graphs, tables and images.
